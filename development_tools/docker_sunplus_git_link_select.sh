...
docker__load_constants__sub() {
    ...
    DOCKER__DIRLIST_REMARK="${DOCKER__FOURSPACES}NOTE: only files containing pattern '${DOCKER__FG_LIGHTGREY}${DOCKER__CONTAINER_ENV1}${DOCKER__NOCOLOR}'...\n"
    DOCKER__DIRLIST_REMARK+="${DOCKER__TENSPACES}...and '${DOCKER__FG_LIGHTGREY}${DOCKER__CONTAINER_ENV2}${DOCKER__NOCOLOR}' are shown"
