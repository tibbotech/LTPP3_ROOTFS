...
docker__load_constants__sub() {
    ...
    DOCKER__ENTER_CMD_LOCATIONINFO="${DOCKER__FOURSPACES}${DOCKER__FG_DARKBLUE}Location${DOCKER__NOCOLOR}: ${DOCKER__FG_LIGHTBLUE}${docker__enter_cmdline_mode_out__fpath}${DOCKER__NOCOLOR}"
...
docker__show_fileContent_handler__sub() {
    ...
    #Update 'menuTitle'
    local menuTitle="${DOCKER__FG_DARKBLUE}Output of command ${DOCKER__NOCOLOR} "
    menuTitle+="<${DOCKER__FG_LIGHTBLUE}${cmd__input}${DOCKER__NOCOLOR}>"
